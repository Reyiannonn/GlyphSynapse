...
public final class AnimationPlayer_Factory implements Factory<AnimationPlayer> {
  ...
  public AnimationPlayer get() {
    return newInstance(glyphManagerProvider.get(), audioAwarenessProvider.get());
  }

  public static AnimationPlayer_Factory create(Provider<GlyphManagerWrapper> glyphManagerProvider,
      Provider<AudioAwareness> audioAwarenessProvider) {
    return new AnimationPlayer_Factory(glyphManagerProvider, audioAwarenessProvider);
  }

  public static AnimationPlayer newInstance(GlyphManagerWrapper glyphManager,
      AudioAwareness audioAwareness) {
    return new AnimationPlayer(glyphManager, audioAwareness);
  }
}

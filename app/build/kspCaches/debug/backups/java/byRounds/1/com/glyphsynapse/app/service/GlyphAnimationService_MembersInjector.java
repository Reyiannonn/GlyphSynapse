...
public final class GlyphAnimationService_MembersInjector implements MembersInjector<GlyphAnimationService> {
  ...
  public static MembersInjector<GlyphAnimationService> create(
      ...
      Provider<AudioAwareness> audioAwarenessProvider,
      Provider<UserPreferencesRepository> prefsProvider) {
    return new GlyphAnimationService_MembersInjector(glyphManagerProvider, animationPlayerProvider, audioAwarenessProvider, prefsProvider);
  }
  ...
  public void injectMembers(GlyphAnimationService instance) {
    ...
    injectAudioAwareness(instance, audioAwarenessProvider.get());
  ...
  @InjectedFieldSignature("com.glyphsynapse.app.service.GlyphAnimationService.audioAwareness")
  public static void injectAudioAwareness(GlyphAnimationService instance,
      AudioAwareness audioAwareness) {
    instance.audioAwareness = audioAwareness;
  }

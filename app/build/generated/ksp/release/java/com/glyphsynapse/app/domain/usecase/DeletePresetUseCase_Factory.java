...
public final class DeletePresetUseCase_Factory implements Factory<DeletePresetUseCase> {
  ...
  public DeletePresetUseCase_Factory(Provider<UserPreferencesRepository> prefsProvider,
  ...
  @Override
  public DeletePresetUseCase get() {
    return newInstance(prefsProvider.get(), loadPresetsProvider.get());
  }

  public static DeletePresetUseCase_Factory create(
      Provider<UserPreferencesRepository> prefsProvider,
      Provider<LoadPresetsUseCase> loadPresetsProvider) {
    return new DeletePresetUseCase_Factory(prefsProvider, loadPresetsProvider);
  }

  public static DeletePresetUseCase newInstance(UserPreferencesRepository prefs,
      LoadPresetsUseCase loadPresets) {
    return new DeletePresetUseCase(prefs, loadPresets);
  }
}
